...
//v1.4版本及以前版本的引用方式：src="http://api.map.baidu.com/api?v=1.4&key=MYmAqUe1VDAikSBA9a8XkP6R&callback=initialize"
	...
	<f:view>
				...
				<rich:tab id="tb12" label="accounts">
					<a4j:commandButton reRender="rep" action="" value="RDU"/>&nbsp;&nbsp;&nbsp;&nbsp;
					 
					 <a4j:commandButton reRender="rep" action="" value="RDL"/> &nbsp;&nbsp;&nbsp;&nbsp;
					 <a4j:commandButton reRender="rep" action="" value="Navigation"/>
            ...
            <table>
     		Chrysler/Mr.Dele Nonyejohn / E-call Non-Emergency/ <rich:separator>  </rich:separator> 
				<tr>
					<td>
					<a4j:commandButton reRender="rep" action="" value="Menu"/>
					</td>
					<td><a4j:commandButton reRender="rep" action="" value="New"/></td>
					<td><a4j:commandButton reRender="rep" action="" value="Save"/></td>
					<td><a4j:commandButton reRender="rep" action="" value="Query"/></td>			 
					</tr>
					</table>
	 ...
	 <br><br><br><br><br><br>
		...
		<table  align="left"  style="layoutTable">
				...
				<rich:tab id="tb3" label="service requests">
				  <p class="order-table-header" scope="col">Service Requsets List</p> 
				  <a4j:commandButton reRender="rep" action="#{button.callEric}" value="Menu"/>
					&nbsp;<a4j:commandButton reRender="rep" action="" value="New"/>
					&nbsp;<a4j:commandButton reRender="rep" action="" value="Delete"/>
					&nbsp;<a4j:commandButton reRender="rep" action="" value="Save"/>
					&nbsp;<a4j:commandButton reRender="rep" action="" value="Query"/>
