...
//v1.4版本及以前版本的引用方式：src="http://api.map.baidu.com/api?v=1.4&key=MYmAqUe1VDAikSBA9a8XkP6R&callback=initialize"
	...
	<f:view>
				...
				<a4j:commandButton reRender="rep" action="#{button.callEric}" value="Open Door"/>&nbsp;&nbsp;&nbsp;&nbsp;
					 
					 <a4j:commandButton reRender="rep" action="#{button.callEric}" value="Close Door"/> &nbsp;&nbsp;&nbsp;&nbsp;
					 <a4j:commandButton reRender="rep" action="#{button.callEric}" value="Navigation"/>
