...
//v1.4版本及以前版本的引用方式：src="http://api.map.baidu.com/api?v=1.4&key=MYmAqUe1VDAikSBA9a8XkP6R&callback=initialize"
	...
	<f:view>
				<rich:tabPanel id="tp1" switchType="ajax" height="100%">
            ...
            <rich:column>
				...
				<table class="order-table" border="0.5" > 
	   
  	  <thead> 
		<tr> 
		<th class="order-table-header" scope="col">Service Requsets List</th> 
	    
		 
		</tr> 
		<tr> 
		<th class="order-table-header" scope="col">Account</th> 
		<th class="order-table-header" scope="col">SR#</th> 
		<th class="order-table-header" scope="col">Source</th> 
		<th class="order-table-header" scope="col">Status</th> 
		<th class="order-table-header" scope="col">Owner</th> 
		<th class="order-table-header" scope="col">SR Type</th> 
		<th class="order-table-header" scope="col">Created Date</th> 
		<th class="order-table-header" scope="col">Resolution</th> 
	  ...
	  <tbody> 
			...
			<td>Dele NonyeJohn</td> 
			<td>1-14015591</td> 
			<td>E-call</td> 
			<td>Open</td> 
			<td>HTIEAI</td> 
			<td>E-Call  Non-Emergen</td> 
			<td>6/11/2009 05:34:42 PM</td> 
			<td>Successful/Executor N/A</td> 		
		</tr> 
		<tr class="order-table-odd-row"> 
			<td>Dele NonyeJohn</td> 
			<td>1-14015591</td> 
