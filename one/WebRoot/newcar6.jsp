         ...
         <f:facet name="footer">
          ...
          <rich:column>
            <h:outputText value="成功执行" />
				...
				<table><tr><td>
				本田/张三 /不紧急的紧急呼叫/  	<rich:separator>  </rich:separator> </td></tr>
				<tr>
					...
					<td><a4j:commandButton reRender="rep" action="" value="DTMF定位"/></td>
					<td><a4j:commandButton reRender="rep" action="" value="提交"/></td>
					<td><a4j:commandButton reRender="rep" action="" value="再发送数据信息"/></td>
					<td><a4j:commandButton reRender="rep" action="" value="客户入口"/></td>
					<td><a4j:commandButton reRender="rep" action="" value="刷新"/></td>
